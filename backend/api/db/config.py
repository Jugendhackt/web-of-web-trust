...
config = Config(".env")
API_RELOAD = config("API_RELOAD", cast=bool, default=False)
API_DEBUG = config("API_DEBUG", cast=bool, default=False)
API_HOST = config("API_HOST", default="127.0.0.1")
API_PORT = config("API_PORT", cast=int, default=8080)
API_SSL = config("API_SSL", cast=bool, default=False)
